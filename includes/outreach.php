...
function outreach_signature_html(): string {
    ...
    if ($company !== '') $h .= '<div style="font-size:30px;font-weight:700;letter-spacing:1px;color:#11151c;font-family:\'Century Gothic\',Futura,Arial,sans-serif">' . e($company) . '</div>';
    if ($bcorp) $h .= '<div style="margin-top:14px;color:#11151c;font-family:' . $F . '"><div style="font-size:9px;font-weight:700;letter-spacing:1.4px;text-transform:uppercase;line-height:1.3">Empresa</div><div style="font-size:15px;font-weight:700;line-height:1.2;margin:1px 0">B</div><div style="font-size:9px;font-weight:700;letter-spacing:1.4px;text-transform:uppercase;line-height:1.3">Certificada</div></div>';
    $h .= '</td></tr></table>';
